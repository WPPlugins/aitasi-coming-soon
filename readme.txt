...
Tags: coming soon, coming soon page, construction, landing page, launch, launch page, maintenance, maintenance mode, newsletter, offline, unavailable, under construction, wordpress coming soon, wordpress maintenance mode, wordpress under construction, aitasi coming soon, wordpress coming soon plugin
...
* Contact Form is available to contact with admin instantly (* Install Contact Form 7)
...
2. Search for ‘Aitasi Coming Soon’
3. Click 'Install Now'
4. Activate the plugin on the Plugin dashboard
5. Go to Settings > Aitasi Settings to configure the plugin

= Uploading in WordPress Dashboard =

1. Navigate to the 'Add New' in the plugins dashboard
2. Navigate to the 'Upload' area
3. Select ‘aitasi-coming-soon.zip’ from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard
6. Go to Settings > Aitasi Settings to configure the plugin

= Using FTP =

1. Download ‘Aitasi Coming Soon’ Plugin
2. Extract the ‘aitasi-coming-soon’ directory to your computer
3. Upload the ‘aitasi-coming-soon’ directory to the `/wp-content/plugins/` directory
...
1. Coming Soon Section (Free)
2. Coming Soon Section (Pro)
3. Service Section (Pro)
4. Team Section (Pro)
5. Contact Section (Pro)
6. Footer (Pro)
